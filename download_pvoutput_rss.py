...
ukgrid = grd.generate_grid(
    countries=["France", "Italy", "Spain", "Germany", "Egypt", "Denmark", "Belgium", "Luxembourg", "Switzerland", "Austria", "Sweden", "Norway", "Portugal", "Ukraine", "Malta", "Iceland", "Liechtenstein",
               ...
               "North Macedonia", "Kosovo", "Albania", "Montenegro", "Serbia", "Finland", "Belarus", "Greece", "Cyprus", "Ireland", "Estonia", "Algeria", "Libya"], # List as many countries as you want, or set to None for world-wide
...
systems.to_csv("PVOutput_RSS_systems.csv")
...
metadata.to_csv("PVOutput_RSS_systems_metadata.csv")
metadata.head()
